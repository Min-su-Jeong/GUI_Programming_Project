...
public class TMPColorDefeat : MonoBehaviour
{
    [SerializeField]
    ...
    private IEnumerator ColorLerpLoop()
    {
        ...
        {
            // 색상을 하얀색 -> 빨간색
            yield return StartCoroutine(ColorLerp(Color.white, Color.black));
            // 색상을 빨간색 -> 하얀색
            yield return StartCoroutine(ColorLerp(Color.black, Color.white));
        }
    }
